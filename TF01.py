...
# Версия pandas
# «панельные данные», используется для описания многомерных структурированных наборов информации.
# для обработки и анализа данных. Работа pandas с данными строится поверх библиотеки NumPy
import pandas as pd
...
# Где данные
TrainFile = "C:\\Python35\\TF01\\SiU6.txt"
...
if __name__ == '__main__':
    ...
    print("Downloading data from {}".format(TrainFile))
    frame = download_data()
